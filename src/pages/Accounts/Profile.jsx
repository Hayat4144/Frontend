...
export default function Profile() {
  ...
  return (
    <Fragment>
      <div className="profile_page w-full h-full">
        <Suspense fallback={<NavbarSkeleton />}>
          <Navbar />
        </Suspense>
        <div className="bg-gray-100 p-5">
          <div className="profile_box py-10 mx-5 sm:w-5/6 md:w-2/4 md:mx-auto px-5 bg-white">
              ...
              >
                ...
                <div className="sumbit-btn my-5">
                  {!isLoading ? (
                    ...
                    text-sm shadow rounded-md text-white bg-indigo-                 hover:bg-indigo-900
                     w-full text-center transition ease-in-out duration-                    cursor-not-allowed"
                      disabled=""
                    >
                      <svg
